...
export const App = () => {
  ...
  const submit = () => {
    window.gtag('event', 'may_ios_engage_var2');
    setLoading(true);
      ...
      <>
        <div className={appSt.container}>
          <div className={appSt.textTitle}>
            ...
            <Typography.Text
              ...
              onClick={() => {
                window.gtag('event', 'may_ios_what_is_var2');
                setStep('init');
              }}
            >
        ...
        <div className={appSt.bottomBtn}>
          <ButtonMobile
            ...
            view="secondary"
            onClick={() => {
              window.gtag('event', 'may_ios_combination_var2');
    ...
    <>
      ...
      <div className={appSt.bottomBtn}>
        <ButtonMobile
          ...
          view="primary"
          onClick={() => {
            window.gtag('event', 'may_ios_luck_var2');
            setStep('numbers');
          }}
        >
